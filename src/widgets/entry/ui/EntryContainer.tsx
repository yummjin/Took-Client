...
export default function EntryContainer() {
  ...
  return (
    <div className="flex size-full flex-col">
      ...
      <div className="absolute bottom-0 z-10 flex h-[582px] w-full flex-col items-center rounded-t-lg border-t-[2px] border-white bg-white/50 p-10 backdrop-blur-[2px]">
